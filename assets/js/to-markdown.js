...
(function(f) {
  ...
  return (function e(t, n, r) {
    ...
    2: [function(require, module, exports) {
      ...
      {
        filter: function(node) {
          return node.nodeName === 'PRE' && node.parentNode.nodeName === 'P' && highlightRegEx.test(node.parentNode.className);
        },
        replacement: function(content, node) {
        ...
        filter: function(node) {
          return node.nodeName === 'P' && highlightRegEx.test(node.className);
        },
        replacement: function(content) {
          return '\n\n' + content + '\n\n';
        }
